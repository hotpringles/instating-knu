...
export default function UserDetailPage() {
  ...
  if (!card) {
    return (
      <div className="relative mx-auto flex h-screen w-full max-w-md flex-col items-center justify-center overflow-hidden bg-background-light font-display shadow-lg dark:bg-background-dark">
